    ...
    children: [
      {
        ...
        name: '角色管理',
        icon: 'User',
        component: () => import('@/views/permission/sysRole/sysRoleList.vue'),
      },
      {
        path: '/system/user',
        name: '用户管理',
        icon: 'User',
        component: () => import('@/views/permission/sysUser/sysUserList.vue'),
      },
      {
        path: '/system/menu',
        name: '菜单管理',
        icon: 'Menu',
        component: () => import('@/views/permission/sysMenu/sysMenuList.vue'),
      },
      {
        path: '/system/api',
        name: '接口管理',
        icon: 'SetUp',
        component: () => import('@/views/permission/sysApi/sysApiList.vue'),
      },
    ],
  },
]
